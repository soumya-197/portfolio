...
const Aboutdisc = () => {
  return (
    <div className="">
        ...
        <Socialprofiles/>
        <button className='underlineanim mt-5 bg-cyan-500 p-3 rounded-3xl w-56 hover:bg-gray-700 hover:w-72 duration-500'><a className=' font-bold text-xl' href='https://drive.google.com/file/d/1WBk__ihi8sYD7aR0k5InOVUfLQcJuWWA/view?usp=sharing'>RESUME</a></button>
    </div>
  )
}
